...
export default class DonutChartStats extends React.Component {
  ...
  // This would have gone in code-wise if it didn't break all of the mocha tests. So now there's a screenshot of what it looked like as a placeholder
  ...
  render() {
    return (
      <div className="donut-chart-container">
        <img src="../images/pieChartStats.png" />
      </div>
    );
  }
}
